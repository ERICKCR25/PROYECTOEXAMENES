		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
		                                           <input class="form-control" id="id_ID" readonly="readonly" name="idexamen" type="text" maxlength="8"/>
		                                        </div>
		                                     </div>
		                                     <div class="form-group">
		                                   ...
		                                   <input type="hidden" name="claves" id="id_act_claves" value="">
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_numPreguntas" name="numPreguntas" placeholder="Ingrese la fecha de inicio" type="text" maxlength="15"/>
		                                        </div>
		                                    </div>    
		                                    <div class="form-group">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-5">
													<input class="form-control" id="id_act_porAprobacion" name="porAprobacion" placeholder="Ingrese porAprobacion" type="text" maxlength="12"/>
		                                        </div>
		                                    </div>
		                                    <div class="form-group">
